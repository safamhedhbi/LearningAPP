...
public class test2 extends AppCompatActivity {
    ...
    private void questionSet(int i) {
    ...
    public void showResult(){
        ...
        if (score> (questionCountTotal-score)) {
            note = "Bravo!!"+tabShow();
        } else note = "Vous pouvez faire mieux!"+tabShow();
    ...
    public void onBackPressed() {
        Intent intent1= new Intent(test2.this,Choix_CQE.class);
